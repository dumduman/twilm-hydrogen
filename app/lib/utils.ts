...
export const INPUT_STYLE_CLASSES =
  'appearance-none dark:bg-transparent border akzidenz-light focus:border-primary/50 focus:ring-0 w-full py-2 px-3 text-primary/90 placeholder:text-primary/50 leading-tight focus:shadow-outline';
